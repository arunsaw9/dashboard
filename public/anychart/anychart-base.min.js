...
c=a?this.gJ():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.De(this.g,{href:a?this.iJ():"",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.De(this.b,{alt:a?this.hJ():"AnyChart - JavaScript Charts"}),this.I(gl));this.J(hl)&&(a=a?this.text():"",$.ef(this.D,a),this.I(hl));if(this.J(il)){if(a=nl(this)?this.HE():kl()){if(this.O=a,b=rh($.kg()))$.Id(b,"complete",this.w2,!1,this),$.Id(b,
